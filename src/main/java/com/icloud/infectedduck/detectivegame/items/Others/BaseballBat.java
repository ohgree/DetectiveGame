 ...
 */
public class BaseballBat extends ItemBase {
    public BaseballBat() {
        initKillItem(KillType.MACE);
        initItem("몽둥이", new ItemStack(Material.BONE, 1), 0, Arrays.asList(ProfessionBase.Profession.NONE),
                Arrays.asList(ItemTarget.NPC), new String[]{
                        ChatColor.GRAY + "뚜까뚜까 팹시다."
                });
    }
}
