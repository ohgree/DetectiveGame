 ...
 */
public class KCN extends ItemBase { //Potassium Cyanide
    public KCN() {
        initKillItem(KillType.POISON, 40);
        initItem("청산가리", new ItemStack(Material.SUGAR, 1), 4, Arrays.asList(ProfessionBase.Profession.NONE),
                Arrays.asList(ItemTarget.NPC), new String[]{
                        ChatColor.GRAY + "강력한 독입니다.",
                        ChatColor.DARK_GREEN + "주사 40초 후" + ChatColor.GRAY + " 대상이 사망합니다."
                });
    }
}
