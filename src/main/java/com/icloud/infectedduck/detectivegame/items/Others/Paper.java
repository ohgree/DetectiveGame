 ...
 */
public class Paper extends ItemBase {
    public Paper() {
        initKillItem(KillType.SUFFOCATION);
        initItem("보자기", new ItemStack(Material.PAPER, 1), 2, Arrays.asList(ProfessionBase.Profession.NONE),
                Arrays.asList(ItemTarget.NPC), new String[]{
                        ChatColor.DARK_GREEN + "당신들 누구야??? 읍읍!!",
                        ChatColor.GRAY + "가위에 집니다."
                });
    }
}
