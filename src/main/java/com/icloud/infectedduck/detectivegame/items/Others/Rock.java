 ...
 */
public class Rock extends ItemBase {
    public Rock() {
        initKillItem(KillType.MACE);
        initItem("바위", new ItemStack(Material.FIREWORK_CHARGE, 1), 0, Arrays.asList(ProfessionBase.Profession.NONE),
                Arrays.asList(ItemTarget.NPC), new String[] {
                        ChatColor.GRAY + "보자기에 집니다."
                });
    }
}
