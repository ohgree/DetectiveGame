 ...
 */
public class Scissors extends ItemBase {
    public Scissors() {
        initKillItem(KillType.BLADE);
        initItem("가위", new ItemStack(Material.SHEARS, 1), 0, Arrays.asList(ProfessionBase.Profession.NONE),
                Arrays.asList(ItemTarget.NPC), new String[] {
                        ChatColor.GRAY + "바위에 집니다."
                });
    }
}
